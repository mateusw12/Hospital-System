...
export class DoctorAppointmentRegistrationComponent implements OnInit {
  ...
  private getModel(): DoctorAppointment {
    ...
    model.hospitalId = this.hospitald;
    model.patientId = formValue.patientId as number;
