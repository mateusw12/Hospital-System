...
public class SwaggerConfiguration {
    ...
    private final String API_DESCRIPTION = "A API de hospital é projetada para fornecer uma interface" +
            " de programação de aplicativos (API) para gerenciar os dados de um hospital. " +
            "Ela permite que os desenvolvedores criem aplicativos que" +
            " possam realizar operações CRUD (criar, ler, atualizar e excluir) " +
            "em dados de hospital, como pacientes, doenças, empresas. " +
